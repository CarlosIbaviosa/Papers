...
As in Experiment 1, we observed no significant difference in confidence across image rates, contrary to our prediction. Similar to Experiment 1, it seems that the task demands were too difficult in each condition for participants to feel confident - fingerprint matching tasks are quite challenging for novices (Searston & Tangen, 2017c; Tangen et al., 2011; Thompson et al., 2014), and would likely still be challenging when viewing an RSVP stream.
